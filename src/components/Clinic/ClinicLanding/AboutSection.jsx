      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <ClinicImage src={clinic.aboutImage} alt="À propos de notre clinique" className="w-full h-72 md:h-80" />
            <div className="space-y-6">
              <p className="text-lg leading-relaxed">
                {clinic.longDescription || `Notre clinique s'engage à fournir des soins d'excellence dans un environnement moderne et accueillant. Notre équipe pluridisciplinaire met tout en œuvre pour votre bien‑être, de la prévention au suivi personnalisé.`}
              </p>
